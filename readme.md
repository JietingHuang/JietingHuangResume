...
简历为仿写，原简历页面地址: [刘子健 - 个人简历](https://resume.lxxyx.cn/)

* 简历基于 Gulp+Scss+Jade。  
* 访问地址：[黄杰亭 的简历](https://resume.JietingHuang.cn)
...
在 gulp.js 与 info.json 中，替换 JietingHuangResume.pdf 为你自己想要的名字, 在 src 源中生成新的pdf
